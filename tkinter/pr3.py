...
root = tk.Tk()
#Лого
icon = tk.PhotoImage(file="sport.png")
...
label3 = tk.Label(root, text="Лодырь")
label3.place(x=310, y=100)

label4 = tk.Label(root, text="Бестолочь")
label4.place(x=380, y=100)

label5 = tk.Label(root, text="Инвалид")
label5.place(x=460, y=100)

label6 = tk.Label(root, text="Стрельба из лука")
label6.place(x=170, y=140)

label7 = tk.Label(root, text="Дартс")
label7.place(x=200, y=180)

label8 = tk.Label(root, text="биатлон")
label8.place(x=200, y=220)

label9 = tk.Label(root, text="Общий балл:")
label9.place(x=180, y=260)
...
#изображение
image = PhotoImage(file="sport.png")
